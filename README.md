# 📊 DjangoPolls - Dinamik Anket ve Oylama Sistemi

> Gelişmiş web standartlarına uygun olarak tasarlanmış, kullanıcı etkileşimli ve ölçeklenebilir bir Django anket uygulaması. 
...
- [ ] **Kullanıcı Kimlik Doğrulama:** Kayıtlı kullanıcıların anket oluşturabilmesi ve oylarının profilleriyle eşleşmesi.
